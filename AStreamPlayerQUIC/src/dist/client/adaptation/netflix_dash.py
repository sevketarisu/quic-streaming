...
def netflix_dash(bitrates, dash_player, segment_download_rate, curr_bitrate, average_segment_sizes, rate_map, state,JUMP_BUFFER_COUNTER):
    """
    Netflix rate adaptation module
    """
    current_buffer_size=dash_player.buffer.qsize()
    if JUMP_BUFFER_COUNTER>0:
        current_buffer_size=config_dash.NETFLIX_BUFFER_SIZE
    ...
    return next_bitrate, rate_map, state,JUMP_BUFFER_COUNTER