...
def weighted_dash(bitrates, dash_player, weighted_dwn_rate, curr_bitrate, next_segment_sizes,JUMP_BUFFER_COUNTER):
    """
    ...
    if JUMP_BUFFER_COUNTER>0:
        current_buffer_size=config_dash.BETA_BUFFER_COUNT
        JUMP_BUFFER_COUNTER=JUMP_BUFFER_COUNTER-1

    available_video_segments = current_buffer_size - dash_player.initial_buffer
