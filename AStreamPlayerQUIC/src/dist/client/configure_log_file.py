...
def configure_log_file(playback_type="",connection_type="",log_file=config_dash.LOG_FILENAME):
    ...
    if log_file:
        log_filename = "_".join((log_file,connection_type,playback_type, strftime('%Y-%m-%d.%H_%M_%S.log')))
