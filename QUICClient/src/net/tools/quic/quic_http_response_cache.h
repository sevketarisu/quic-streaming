...
class QuicHttpResponseCache {
 public:
  ...
  const Response* GetResponse(QuicStringPiece host, QuicStringPiece path)   ;
  ...
  void FindResponseAndAddToCache(QuicStringPiece host, QuicStringPiece path, const std::string& cache_dir) ;
